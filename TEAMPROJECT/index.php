...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="navbar-header">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#foodMenu">About Us</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#foodMenu">Study Group Menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#foodMenu">Developer Community</a>
                </li>
                <li class="nav-item">
